...
import br.com.model.SellerValue;
...
public class SalesService {
    ...
    public List<String> worstSeller(){
      List<SaleModel> getSales = salesData.getVendaModel().stream().distinct().collect(Collectors.toList());
    ...
    public String getBestSalling() {
        return salesData.getVendaModel().stream().max(Comparator.comparing(i -> i.getSaleValue())).get().getNumberSale();
    }
}
